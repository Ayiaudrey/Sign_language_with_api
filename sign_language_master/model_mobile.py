...
Chargez MobileNet ou Inception CNN prétraité et effectuez quelques vérifications.
Les modèles sont chargés sans les couches supérieures, ce qui convient à l'extraction de caractéristiques.
"""
