...
Pour la formation des réseaux neuronaux, la méthode Keras.model.fit_generator est utilisée. 
Cela nécessite un générateur qui lit et fournit des données d'entraînement au moteur Keras.
"""
...
class FramesGenerator(keras.utils.Sequence):
    ...
    Lecture et rendement des images vidéo/flux optiques pour Keras.model.fit_generator
    Le générateur peut être utilisé en multi-threading.
    Initialisation et vérifications importantes en amont, y compris le codage des étiquettes en une seule fois.
    """
    ...
    def __init__(self, sPath:str, \
        ...
        #récupérer toutes les vidéos = répertoires d'images
        ...
        #extraire les étiquettes (texte) du chemin
        ...
        if liClassesFull != None:
            ...
            #utiliser un sur-ensemble de classes fournies
...
class FeaturesGenerator(keras.utils.Sequence):
    ...
    Lit et produit des caractéristiques I3D (prétraitées) pour Keras.model.fit_generator.
    Le générateur peut être utilisé en multi-threading.
    Initialisation et vérifications substantielles en amont, y compris le codage des étiquettes en un coup.
    """
    ...
    def __init__(self, sPath:str, nBatchSize:int, tuXshape, \
        ...
        #récupérer tous les fichiers de caractéristiques
...
class VideoClasses():
    ...
    Charge les classes vidéo (y compris les descriptions) à partir d'un fichier csv.
    """
